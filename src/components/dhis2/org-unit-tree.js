...
export default class OrgUnitTreeComponent extends React.Component {
	constructor (props) {
		...
		d2.models.organisationUnits
			...
			.then(() => Promise.all([
				d2.models.organisationUnits.get('WnbiO7uqykr', { fields: childFields }),
				d2.models.organisationUnits.get('WnbiO7uqykr', { fields: childFields }),
	...
	render () {
		...
		return (
            <div>
                ...
                <ImporterController d2={this.state.d2} orgUnitId={this.state.userOrgUnitId} orgUnit={this.state.userOrgUnitName}/>
